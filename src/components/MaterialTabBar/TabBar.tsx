...
import { Indicator } from 'react-native-collapsible-tab-view/src/MaterialTabBar/Indicator';
import { MaterialTabItem } from './TabItem';
import { ItemLayout } from 'react-native-collapsible-tab-view/src/MaterialTabBar/types';
